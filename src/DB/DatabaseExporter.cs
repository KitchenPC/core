...
public class DatabaseExporter : IDisposable, IProvisioner
{
      ...
      where T : new()
   {
      ...
      var persister =
         session.GetSessionImplementation().GetEntityPersister(null, new T()) as ILockable;
      if (persister == null)
   ...
   {
      var list = ImportTableData<Models.IngredientMetadata, IngredientMetadata>(
            r => new IngredientMetadata
            {
   ...
   {
      var list = ImportTableData<Models.Ingredients, Ingredients>(r => new Ingredients
         {
            IngredientId = (Guid)r["IngredientId"],
   ...
   {
      var list = ImportTableData<Models.NlpAnomalousIngredients, NlpAnomalousIngredients>(
            r => new NlpAnomalousIngredients
            {
   ...
   {
      var list = ImportTableData<Models.NlpDefaultPairings, NlpDefaultPairings>(
            r => new NlpDefaultPairings
            {
   ...
   {
      var list = ImportTableData<Models.NlpIngredientSynonyms, NlpIngredientSynonyms>(
            r => new NlpIngredientSynonyms
            {
   ...
   {
      var list = ImportTableData<Models.Recipes, Recipes>(r => new Recipes
         {
   ...
   {
      var list = ImportTableData<Models.RecipeIngredients, RecipeIngredients>(
            r => new RecipeIngredients
            {
   ...
   {
      var list = ImportTableData<Models.Menus, Menus>(r => new Menus
         {
   ...
   {
      var list = ImportTableData<Models.ShoppingLists, ShoppingLists>(r => new ShoppingLists
         {
   ...
   {
      var list = ImportTableData<Models.ShoppingListItems, ShoppingListItems>(
            r => new ShoppingListItems
            {
