...
public class RecipeMetadata
{
   ...
   public static RecipeMetadata FromId(Guid id) => new() { RecipeMetadataId = id };
   ...
   public virtual RecipeTags Tags
   {
      get
      {
         ...
         if (MealLunch)
            t |= RecipeTag.Lunch;
         if (NutritionLowCalorie)
            t |= RecipeTag.LowCalorie;
         if (NutritionLowCarb)
            t |= RecipeTag.LowCarb;
         if (NutritionLowFat)
            t |= RecipeTag.LowFat;
         if (NutritionLowSodium)
            t |= RecipeTag.LowSodium;
         if (NutritionLowSugar)
...
public class RecipeMetadataMap : ClassMap<RecipeMetadata>
{
   ...
   {
      Id(x => x.RecipeMetadataId, "id").GeneratedBy.GuidComb().UnsavedValue(Guid.Empty);

      Map(x => x.Commonality).Not.Nullable().Index("IDX_RecipeMetadata_Commonality");
      Map(x => x.DietGlutenFree, "diet_glutenfree")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_DietGlutenFree");
      Map(x => x.DietNoAnimals, "diet_noanimals")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_DietNoAnimals");
      ...
      Map(x => x.DietNoRedMeat, "diet_noredmeat")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_DietNoRedMeat");
      Map(x => x.MealBreakfast, "meal_breakfast")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_MealBreakfast");
      Map(x => x.MealDessert, "meal_dessert")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_MealDessert");
      ...
      Map(x => x.NutritionLowCalorie, "nutrition_lowcalorie")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_NutritionLowCalorie");
      Map(x => x.NutritionLowCarb, "nutrition_lowcarb")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_NutritionLowCarb");
      Map(x => x.NutritionLowFat, "nutrition_lowfat")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_NutritionLowFat");
      Map(x => x.NutritionLowSodium, "nutrition_lowsodium")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_NutritionLowSodium");
      Map(x => x.NutritionLowSugar, "nutrition_lowsugar")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_NutritionLowSugar");
      Map(x => x.NutritionTotalCalories, "nutrition_totalcalories")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_NutritionTotalCalories");
      Map(x => x.NutritionTotalCarbs, "nutrition_totalcarbs")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_NutritionTotalCarbs");
      Map(x => x.NutritionTotalfat, "nutrition_totalfat")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_NutritionTotalfat");
      Map(x => x.NutritionTotalSodium, "nutrition_totalsodium")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_NutritionTotalSodium");
      Map(x => x.NutritionTotalSugar, "nutrition_totalsugar")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_NutritionTotalSugar");
      Map(x => x.PhotoRes).Not.Nullable().Index("IDX_RecipeMetadata_PhotoRes");
      Map(x => x.SkillCommon, "skill_common")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_SkillCommon");
      ...
      Map(x => x.TasteMildToSpicy, "taste_mildtospicy")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_TasteMildToSpicy");
      Map(x => x.TasteSavoryToSweet, "taste_savorytosweet")
         .Not.Nullable()
         .Index("IDX_RecipeMetadata_TasteSavoryToSweet");
