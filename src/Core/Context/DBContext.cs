...
public class DBContext : IKPCContext, IProvisionSource, IProvisionTarget
{
    ...
    public sealed class AsUser : DBContext
    {
        ...
        private AsUser(IngredientParser ingParser, ModelerProxy modeler, Parser parser, IDBAdapter adapter, AuthIdentity identity)
        {
    ...
    public virtual ModelingSession CreateModelingSession(IUserProfile profile) => ModelerProxy.CreateSession(profile);
    ...
    public virtual SearchResults RecipeSearch(RecipeQuery query) => Adapter.RecipeSearch(Identity, query);
    ...
    /// <returns></returns>
    public virtual Recipe[] ReadRecipes(Guid[] recipeIds, ReadRecipeOptions options) => Adapter.ReadRecipes(Identity, recipeIds, options);
    ...
    public virtual void DequeueRecipe(params Guid[] recipeIds) => Adapter.DequeueRecipe(Identity, recipeIds);
    ...
    public virtual void EnqueueRecipes(Guid[] recipeIds) => Adapter.EnqueueRecipes(Identity, recipeIds);
    ...
    public virtual void RateRecipe(Guid recipeId, Rating rating) => Adapter.RateRecipe(Identity, recipeId, rating);
    ...
    public virtual IngredientFormsCollection ReadFormsForIngredient(Guid id) => Adapter.ReadFormsForIngredient(id);
    ...
    /// <returns>A KitchenPC Ingredient object, or null if no matching ingredient was found.</returns>
    public virtual Ingredient ReadIngredient(string ingredient) => Adapter.ReadIngredient(ingredient);
    ...
    public virtual Menu[] GetMenus(IList<Menu> menus, GetMenuOptions options) => Adapter.GetMenus(Identity, menus, options);
    ...
    /// <returns></returns>
    public virtual MenuResult UpdateMenu(Guid? menuId, Guid[] recipesAdd, Guid[] recipesRemove, MenuMove[] recipesMove, bool clear, string newName = null) => Adapter.UpdateMenu(Identity, menuId, recipesAdd, recipesRemove, recipesMove, clear, newName);
    ...
    public virtual MenuResult CreateMenu(Menu menu, params Guid[] recipeIds) => Adapter.CreateMenu(Identity, menu, recipeIds);
    ...
    public virtual ShoppingListResult CreateShoppingList(ShoppingList list) => Adapter.CreateShoppingList(Identity, list);
    ...
    public virtual void DeleteShoppingLists(ShoppingList[] lists) => Adapter.DeleteShoppingLists(Identity, lists);
    ...
    public virtual ShoppingList[] GetShoppingLists(IList<ShoppingList> lists, GetShoppingListOptions options) => Adapter.GetShoppingLists(Identity, lists, options);
