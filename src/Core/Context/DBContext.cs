...
namespace KitchenPC.Context
{
    ...
    public class DBContext : IKPCContext, IProvisionSource, IProvisionTarget
    {
        ...
        {
            private readonly AuthIdentity identity;
            public override AuthIdentity Identity => identity;
            ...
            {
                return new AsUser(context.ingParser, context.modeler, context.parser, context.Adapter, identity);
            }
        }
        ...
        {
            return AsUser.Clone(this, userContext);
        }
