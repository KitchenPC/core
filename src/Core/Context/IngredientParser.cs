...
{
   private const int MIN_SUBSTR = 3; // TODO: Should this be configurable?
   ...
   private void ParseString(string ing, Guid id)
   {
      var iStart = 0;
      var iLen = MIN_SUBSTR;
   ...
   private void IndexSubStr(string substr, IngredientNode node)
   {
   ...
   private bool FindSubstr(string substr, out ConnectorVertex connections)
   {
      var node = index.Head;
      connections = null;
