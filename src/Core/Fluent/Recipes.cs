...
public class RecipeAction
{
   ...
   public RecipeLoader Load(Recipe recipe) => new(context, recipe);

   public RecipeRater Rate(Recipe recipe, Rating rating) => new(context, recipe, rating);

   public RecipeFinder Search(RecipeQuery query) => new(context, query);
   ...
   public RecipeCreator Create => new(context);
}
...
public class RecipeQueryBuilder
{
   ...
   public RecipeQuery Query => query;
}
...
public class RecipeCreator
{
   ...
   public RecipeResult Commit() => context.CreateRecipe(recipe);
}
