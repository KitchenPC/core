...
internal class TestIngredientLoader : ISynonymLoader<IngredientNode>
{
   ...
   public static Guid ING_BANANAS = new("d54654d8-5d2d-4bda-80ab-82f5d7f008bb");
   ...
   public static Guid ING_LETTUCE = new("55344339-8d1d-4892-a117-ec8018a5e483");

   //Forms for ingredients
   public static Guid FORM_EGG_UNIT = new("821049b8-5789-44dd-a256-824efcb54dab");
   public static Guid FORM_BANANA_UNIT = new("67039fa6-a6a3-4c7e-af97-97cade3f2d19");
   public static Guid FORM_MILK_VOLUME = new("353a5c8f-6a6d-4c7d-a23f-c17805430260");
   public static Guid FORM_FLOUR_VOLUME = new("9bf38fd7-3cc4-4eb5-b2e8-bc77f0978994");
   public static Guid FORM_FLOUR_WEIGHT = new("f9629de4-e51b-45a2-94b2-3e51ccaa5b75");

   public static Guid FORM_LETTUCE_HEAD = new("cc59d558-43ce-48bc-b2fa-ad501d845966");
   public static Guid FORM_CHEESE_MELTED = new("0784f3a5-6f55-44f9-9c55-be5687ca97d8");
   public static Guid FORM_CHEESE_SHREDDED = new("a64c5ccd-6805-4734-8ff8-a1bff6e2b83b");
   public static Guid FORM_CHEESE_DICED = new("58efca93-7c5e-49b3-a04f-e97fe52e9a92");
   ...
   public Pairings LoadFormPairings() => throw new NotImplementedException(); //This will never be called on this type of loader
}
