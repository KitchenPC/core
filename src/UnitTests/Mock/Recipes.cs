...
internal static class Recipes
{
   ...
   public static Recipe BEST_BROWNIES
   {
      get
      {
         ...
         {
            new(Ingredients.MARGARINE, Forms.MARGARINE_VOLUME, new Amount(1, Units.Cup), "in chunks"),
            new(Ingredients.UNSWEETENED_BAKING_CHOCOLATE_SQUARES, Forms.UNSWEETENED_BAKING_CHOCOLATE_SQUARES_WEIGHT, new Amount(1, Units.Ounce), ""),
            new(Ingredients.GRANULATED_SUGAR, Forms.GRANULATED_SUGAR_VOLUME, new Amount(2.66667f, Units.Cup), ""),
            new(Ingredients.EGGS, Forms.EGGS_UNIT, new Amount(4, Units.Unit), "large"),
            new(Ingredients.VANILLA_EXTRACT, Forms.VANILLA_EXTRACT_VOLUME, new Amount(2, Units.Teaspoon), ""),
            new(Ingredients.ALL_PURPOSE_FLOUR, Forms.ALL_PURPOSE_FLOUR_SIFTED, new Amount(1, Units.Cup), "")
         });
