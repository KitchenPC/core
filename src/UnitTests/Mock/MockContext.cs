...
internal class MockContext : IKPCContext
{
    ...
    public IKPCContext AsUserContext(AuthIdentity userContext) => throw new NotImplementedException();


    public IEnumerable<IngredientNode> AutocompleteIngredient(string query) => throw new NotImplementedException();

    public IModelerLoader ModelerLoader => new MockModelerDBLoader("ModelerData.xml");

    public ModelingSession CreateModelingSession(IUserProfile profile) => ModelerProxy.CreateSession(profile);
    ...
    public IngredientFormsCollection ReadFormsForIngredient(Guid id) => throw new NotImplementedException();
    ...
    public ShoppingList[] GetShoppingLists(IList<ShoppingList> lists, GetShoppingListOptions options) => throw new NotImplementedException();
    ...
    public ShoppingListResult CreateShoppingList(ShoppingList list) => throw new NotImplementedException();
    ...
    public IList<IngredientAggregation> AggregateRecipes(params Guid[] recipeIds) => throw new NotImplementedException();

    public IList<IngredientAggregation> AggregateIngredients(params IngredientUsage[] usages) => throw new NotImplementedException();
    ...
    public Menu[] GetMenus(IList<Menu> menus, GetMenuOptions options) => throw new NotImplementedException();
    ...
    public MenuResult UpdateMenu(Guid? menuId, Guid[] recipesAdd, Guid[] recipesRemove, MenuMove[] recipesMove, bool clear, string newName = null) => throw new NotImplementedException();
